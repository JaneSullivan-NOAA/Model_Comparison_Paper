#Last updated: 24 Jan 2022 by JYS for FIMS (nothing changed except Simulation
#details documentation)

#Simulation details: deterministic (logR_sd=0), single fleet, single survey,
#logistic selectivity for both, von Bert growth, Bev-Hol recruitment
...
om_sim_num <- 1 # total iterations per case
...
# NOT RUN ---------------------------
# Jane didn't run anything below this point.
